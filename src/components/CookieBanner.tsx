     ...
     className="fixed bottom-0 left-0 right-0 z-50 rounded-t-2xl px-4 py-2 flex 
      ...
      <div className="mt-2 font-semibold md:mt-0 md:flex space-x-5">
        <button
          ...
          className="px-8 py-1.5 font-serif border border-purple-950 hover:text-white hover:bg-purple-700 rounded-2xl"
        >
          Reject
        </button>
        <button
          onClick={acceptCookies}
          className="px-8 font-serif py-1.5 bg-purple-950 text-white rounded-2xl font-semibold hover:bg-purple-700"
        >
          Accept
        </button>
      </div>
